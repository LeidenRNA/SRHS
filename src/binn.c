...
/*
 * binn.[ch] as per https://github.com/liteserver/binn
 *
 * MODIFICATIONS: added pragmas to ignore -Wmaybe-uninitialized warnings AZ 21032019
 *
 * see APACHE license in 3rd party/Binn
 */
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
